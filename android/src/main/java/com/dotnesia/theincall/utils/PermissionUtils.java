package com.dotnesia.theincall.utils;
...
public class PermissionUtils {
    ...
    public static class RequestPermissionsFragment extends Fragment {
        private TheincallPlugin plugin;

        public void setPlugin(TheincallPlugin plugin){
            this.plugin = plugin;
        }
