...
package com.dotnesia.theincall.AppRTC;
...
import com.dotnesia.theincall.TheincallPlugin;
...
public class AppRTCBluetoothManager {
  ...
  private final TheincallPlugin apprtcAudioManager;
  ...
  /** Construction. */
  public static AppRTCBluetoothManager create(Context context, TheincallPlugin audioManager) {
    Log.d(TAG, "create");
    return new AppRTCBluetoothManager(context, audioManager);
  }

  protected AppRTCBluetoothManager(Context context, TheincallPlugin audioManager) {
    Log.d(TAG, "ctor");
